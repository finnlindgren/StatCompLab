...
```{r multiple-function, exercise=TRUE}
# x: a formula
...
```
```{r ref.label="multiple-function-solution"}
```
...
```
```{r ref.label="plot-extra-solution",eval=TRUE}
```
...
```
```{r ref.label="lapply-lm-solution"}
```
