...
1. Clone your `lab04-*` repository from [https://github.com/StatComp21/](https://github.com/StatComp21/) wither on your own computer (new Project from version control) or to [https://rstudio.cloud](https://rstudio.cloud)
