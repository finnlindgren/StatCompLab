...
2. Download the `RMDemo.Rmd` file from Learn and upload to the Rstudio project and rename it to `Lab4.Rmd`
3. During this lab, modify the `Lab4.Rmd` document and add new code and text commentary for the lab to the document.
