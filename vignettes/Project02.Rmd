...
2. The repository contains three main template files; modify these, but keep their names:
  ...
  * a template `functions.R` file where you should place function defintions
...
The daily precipitation data is more challening to model than temperature, because
