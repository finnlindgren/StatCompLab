...
tutorial:
  ...
  version: 1.3
vignette: |
  %\VignetteIndexEntry{Tutorial 01: R and linear models (solutions)}
...
5. Go to the Learn page and open the \code{Lecture01.pdf} lecture slides so you can refer to them easily during the lab. Read through the pages on formulas and functions before you continue with the lab.
